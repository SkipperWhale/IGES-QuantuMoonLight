...
This repository was developed for the exam <br>
Ingegneria Gestione ed Evoluzione del Software A.Y. 22/23

<h1>IGES-QuantuMoonLight</h1>
...
<ol>
<li> Import the repository on your IDE (ex. using https://github.com/SkipperWhale/IGES-QuantuMoonLight.git)</li>
<li> Open Anaconda Prompt and install the environment.yml using this command (you can find in ./env/LINUX/environment.yml)<br>
